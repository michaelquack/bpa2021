...
<header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
  <div class="w3-display-left w3-text-black" style="padding:48px">
    <span class="w3-jumbo w3-hide-small">Business Professionals of America</span><br>
    <span class="w3-xxlarge w3-hide-large w3-hide-medium">Start something that matters</span><br>
    <span class="w3-large"></span>
    <p><a href="https://negaunee.k12.mi.us/high-school
" class="w3-button w3-white w3-padding-large w3-large w3-margin-top w3-opacity w3-hover-opacity-off">NHS Website</a></p>
  </div> 
...
<div class="w3-container" style="padding:128px 16px" id="about">
  <h3 class="w3-center">ABOUT BPA </h3>
  <p class="w3-center w3-large">Key features of our club</p>
  <div class="w3-row-padding w3-center" style="margin-top:64px">
    <div class="w3-quarter">
      <i class="fa fa-desktop w3-margin-bottom w3-jumbo w3-center"></i>
      <p class="w3-large">Responsive</p>
      <p>We respond to critisism and suport well. If you ask us a question we will get back to you as soon as we can.</p>
    </div>
    <div class="w3-quarter">
      <i class="fa fa-heart w3-margin-bottom w3-jumbo"></i>
      <p class="w3-large">Passion</p>
      <p>We are a passionate group of young men and women, we strive for excellence in our work.</p>
    </div>
    <div class="w3-quarter">
      <i class="fa fa-diamond w3-margin-bottom w3-jumbo"></i>
      <p class="w3-large">Design</p>
      <p>We take great pride in our design work and we are always looking forward to feed back.</p>
    </div>
    <div class="w3-quarter">
      <i class="fa fa-cog w3-margin-bottom w3-jumbo"></i>
      <p class="w3-large">Support</p>
      <p>If you have any questions or complaints please leave them in the contact box below.</p>
    </div>
  </div>
</div>

<!-- Promo Section - "We know (web) design" -->
<div class="w3-container w3-light-grey" style="padding:128px 16px">
  <div class="w3-row-padding">
    <div class="w3-col m6">
      <h3>Design Style</h3>
      <p>We have developed an amazing style for our web design. Please tell us what you think in the comments</p>
      <p><a ></p>
    </div>
    <div class="w3-col m6">
      <img class="w3-image w3-round-large" src="" alt="" width="700" height="394">
    </div>
  </div>
</div>
